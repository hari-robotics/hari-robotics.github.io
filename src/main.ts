...
const bundles: Record<Locale, LocaleBundle> = {
  en: {
    resume: {
      ...
      role: "MSc Student",
      summary:
        "Experienced in mechanical structure design, hardware design, embedded systems, and motion-control algorithms. Capable of end-to-end robot system development and delivering complete workflows from scratch. Strong hands-on engineering skills and problem-solving ability, with a strong interest in robotics research and real-world applications.",
      contacts: [
